...
# и суммарную выплату (s) по кредиту. 
...
# Запросите размер кредита в рублях и копейках, 
# количество целых лет (в годах) и процентную ставку в процентах с точностью до сотых. 
...
# n = float(input("Введите размер кредита: "))
# y = int(input("Введите количество лет кредита: "))
# p = float(input("Введите % кредита: "))
# n = 543.25
# y = 2
# p = 7.45
# p100 = p/100
# m = (n * p100 * (1 + p100)*y) / (12 * ((1 + p100)*y - 1))
...
# а в качестве значения - текст самой истории. 
...
# dictionary = {
#     "первая история": "Моя первая история. Короткая, но интересная",
#     "вторая история": "История про рыбалку. Уха, лодка, палатка и приключения на воде",
#     "третья история": "Приключения в Новый год."
# }
...
# Задача 5:
# Задайте список(произвольный). Напишите программу, которая определит, присутствует ли в заданном списке строк некое число.
...
# Задача 7:
# Программа "Именной фильтр". Напишите функцию, которая принимает на вход список с именами людей и возвращает новый список с именами, которые начинаются на гласную букву. В новом списке имя должно начинаться с прописной (большой) буквы, даже если изначально было написано со строчной(маленькой).
# Пример:
# Введите имена через пробел: Никонор иван Харитон Ульяна яков
# Функция вернула ['Иван', 'Ульяна', 'Яков']

# Задача 8:
# Программа "Среднее арифметическое". Введите целое число от 3 до 20 (число n). Запросите n вещественных чисел и сохраните их в список. Вызовите функцию, которая принимает на вход список (один аргумент) и возвращает среднее арифметическое всех элементов списка. Результат работы функции сохраните в переменную и выведите на экран.
# Пример:
